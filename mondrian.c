...
int square_order, rotate_flag, defect_a, defect_b, options_min, verbose_flag, square_area, *counts, tiles_max, dominances_max, choices_max, nodes_max, column_nodes_max, defect_cur, tiles_n, dominances_n;
mp_t y_cost, x_cost;
